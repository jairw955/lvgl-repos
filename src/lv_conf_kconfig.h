...
#elif defined(CONFIG_LV_FONT_SOURCE_HAN_SANS_SC_14_CJK) && CONFIG_LV_FONT_SOURCE_HAN_SANS_SC_14_CJK
#  define CONFIG_LV_FONT_DEFAULT &lv_font_source_han_sans_sc_14_cjk
#elif defined(CONFIG_LV_FONT_SOURCE_HAN_SANS_SC_16_CJK) && CONFIG_LV_FONT_SOURCE_HAN_SANS_SC_16_CJK
