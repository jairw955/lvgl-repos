...
#define LV_USE_DRAW_SW 1
    ...
    #if LV_USE_DRAW_RK_TRANSFORM == 1
        #define LV_DRAW_RK_TRANSFORM_SCALER_CORES 0
        #define LV_DRAW_RK_TRANSFORM_SCALER_METHOD 0
    #endif
...
#define LV_USE_DRAW_OPENGLES 0
    ...
    #error "LV_DRAW_SW_DRAW_UNIT_CNT should be 1 when LV_USE_DRAW_OPENGLES is enabled"
    #endif
#endif
...
#define LV_CACHE_DEF_SIZE       10485760

/** Default number of image header cache entries. The cache is used to store the headers of images
 *  The main logic is like `LV_CACHE_DEF_SIZE` but for image headers. */
#define LV_IMAGE_HEADER_CACHE_DEF_CNT 500
...
#define LV_USE_SDL              1
    ...
    #define LV_SDL_MOUSEWHEEL_MODE  0  /*LV_SDL_MOUSEWHEEL_MODE_ENCODER/CROWN*/
#endif
...
#define LV_USE_X11              0
    ...
    #define LV_X11_RENDER_MODE_PARTIAL (0 == 0)  /**< Partial render mode (preferred) */
    #define LV_X11_RENDER_MODE_DIRECT  (0 == 1)  /**< Direct render mode */
    #define LV_X11_RENDER_MODE_FULL    (0 == 2)  /**< Full render mode */
#endif
...
#define LV_USE_WAYLAND          0
    ...
    #define LV_WAYLAND_RENDER_MODE          0   /**< DMABUF supports LV_DISPLAY_RENDER_MODE_FULL and LV_DISPLAY_RENDER_MODE_DIRECT*/
